...
function SampleNextArrow(props) {
    ...
    return (
        <>
            <button
                onClick={onClick}
                className="bg-[#00E0CA] btn-hover max-md:hidden text-black p-2 rounded-full z-10 transition-colors md:absolute md:-right-8 md:top-[120px] md:-translate-y-1/2"
...
function SamplePrevArrow(props) {
    ...
    return (
        <>
            ...
            <button
                onClick={onClick}
                className="bg-[#00E0CA] btn-hover max-md:hidden text-black p-2 rounded-full z-10 transition-colors md:absolute md:-left-8 md:top-[120px] md:-translate-y-1/2"
                aria-label="Previous testimonial"
            >
                <ArrowLeft className="h-6 w-6" />
            </button>
